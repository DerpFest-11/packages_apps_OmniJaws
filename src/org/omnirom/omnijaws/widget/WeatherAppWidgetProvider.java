...
public class WeatherAppWidgetProvider extends AppWidgetProvider {
    ...
    private static void updateWeather(
        ...
        widget.setTextViewText(R.id.forecast_temp_0, formatTempString(weatherData.forecasts.get(0).low,
            weatherData.forecasts.get(0).high, weatherData.tempUnits, weatherClient.isMonochromeIcon()));
        ...
        widget.setTextViewText(R.id.forecast_temp_1, formatTempString(weatherData.forecasts.get(1).low,
            weatherData.forecasts.get(1).high, weatherData.tempUnits, weatherClient.isMonochromeIcon()));
        ...
        widget.setTextViewText(R.id.forecast_temp_2, formatTempString(weatherData.forecasts.get(2).low,
            weatherData.forecasts.get(2).high, weatherData.tempUnits, weatherClient.isMonochromeIcon()));
        ...
        widget.setTextViewText(R.id.forecast_temp_3, formatTempString(weatherData.forecasts.get(3).low,
            weatherData.forecasts.get(3).high, weatherData.tempUnits, weatherClient.isMonochromeIcon()));
        ...
        widget.setTextViewText(R.id.forecast_temp_4, formatTempString(weatherData.forecasts.get(4).low,
            weatherData.forecasts.get(4).high, weatherData.tempUnits, weatherClient.isMonochromeIcon()));
        ...
        widget.setTextViewText(R.id.current_temp, formatTempString(weatherData.temp, null, weatherData.tempUnits, weatherClient.isMonochromeIcon()));
    ...
    private static BitmapDrawable overlay(Resources resources, Drawable image, boolean isMonochrome) {
